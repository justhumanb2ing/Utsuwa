...
function SheetViewport({
  ...
  return (
    <SheetPrimitive.Viewport
      className={cn(
        "fixed inset-0 z-50 grid max-w-md w-full mx-auto",
      ...
      <SheetViewport inset={inset} side={side}>
        <SheetPrimitive.Popup
          className={cn(
            ...
            inset &&
              "before:hidden rounded-t-2xl sm:rounded-2xl sm:border sm:before:rounded-[calc(var(--radius-2xl)-1px)] sm:**:data-[slot=sheet-footer]:rounded-b-xl",
            className
          )}
